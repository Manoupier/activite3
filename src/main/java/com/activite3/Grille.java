...
public interface Grille {
     ...
     * @throws IllegalArgumentException si valeur n'est pas un caractere autorise ('1',...'9')
     */
    ...
    /**
     * test si une valeur est possible dans la grille par rapport a ce qu'elle contient deja.
     * @param x
     * @param y
     * @param value
     * @return
